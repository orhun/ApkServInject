...
public final class Constants {
    ...
    public final Pattern androidPackagePattern = Pattern.compile("package=\"(.+?)\"");
    public final Pattern onCreateFindPattern = Pattern.compile(".method (public|protected|private|static) onCreate");
